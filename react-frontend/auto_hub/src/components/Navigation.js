    ...
    <div>
      <nav class="navbar navbar-expand-lg ">
        <div class="container-fluid nav-color">
          <Link to="/home">
            <span class="navbar-brand nav-title">𝐀𝐮𝐭𝐨 𝐇𝐮𝐛</span>
          </Link>
          <button
        ...
        <nav class="navbar navbar-expand-lg menu_bar">
          <div>
            <div id="navbarNavAltMarkup">
              <div class="navbar ">
                <Link to="/SpareParts">
                  <span class="nav-link padding_menu">SpareParts</span>
                </Link>
                <Link to="/oil">
                  <span class="nav-link padding_menu">Oil</span>
                </Link>
                <Link to="/tools">
                  <span class="nav-link padding_menu">Tools</span>
                </Link>
                <Link to="/machinery">
